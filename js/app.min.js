...
let slider_horses = new Swiper('.slider-horses__swiper', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Dotts
	pagination: {
		el: '.slider-horses__dots',
		clickable: true,
	},
	// Arrows
	navigation: {
		nextEl: '.slider-horses .slider-horses__next',
		prevEl: '.slider-horses .slider-horses__prev',
	},
	/*
	breakpoints: {
		320: {
